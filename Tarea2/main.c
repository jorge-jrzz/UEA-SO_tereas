    ...
    while (option != 4) {
        switch (option) {
            case 1:
                ...
                break;
            case 2:
            // gcc utils.c readFile.c -o readFile -I .h && ./readFile
                system("clear");
                ...
                if (pid1 < 0) {
                    ...
                    execl("/usr/bin/gcc", "gcc", "utils.c", "readFile.c", "-o", "readFile", "-I", ".h", NULL);
                    // Si execl falla
                    perror("execl failed");
                    exit(1);
                }
            ...
            case 3:
                ...
                if (pid1 < 0) {
                    ...
                    // Código del proceso hijo: compilar los archivos con gcc
                    execl("/usr/bin/gcc", "gcc", "utils.c", "searchRegister.c", "-o", "searchRegister", "-I", ".h", NULL);
                    // Si execl falla
                    perror("execl failed");
                    exit(1);
                }
                ...
                if (pid2 < 0) {
                    ...
                    // Código del proceso hijo: ejecutar el programa compilado
                    execl("./searchRegister", "./searchRegister", NULL);
                    // Si execl falla
                    perror("execl failed");
                    exit(1);
                }
